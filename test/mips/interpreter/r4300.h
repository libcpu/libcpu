...
// ** modified by Lemmy
#define TLBPGMASK_4K		(0<<13)
#define TLBPGMASK_16K		(3<<13)
#define TLBPGMASK_64K		(15<<13)
#define TLBPGMASK_256K		(63<<13)
#define TLBPGMASK_1M		(255<<13)
#define TLBPGMASK_4M		(1023<<13)
// ** end modification
...
#define	C0_INX		0x0
#define	C0_RAND		0x1
#define	C0_ENTRYLO0	0x2
#define	C0_ENTRYLO1	0x3
#define	C0_CONTEXT	0x4
#define	C0_PAGEMASK	0x5		/* page mask */
#define	C0_WIRED	0x6		/* # wired entries in tlb */
#define	C0_BADVADDR	0x8
#define	C0_COUNT	0x9		/* free-running counter */
#define	C0_ENTRYHI	0x10
#define	C0_SR		0x12
#define	C0_CAUSE	0x13
#define	C0_EPC		0x14
#define	C0_PRID		0x15		/* revision identifier */
#define	C0_COMPARE	0x11		/* counter comparison reg. */
#define	C0_CONFIG	0x16		/* hardware configuration */
#define	C0_LLADDR	0x17		/* load linked address */
#define	C0_WATCHLO	0x18		/* watchpoint */
#define	C0_WATCHHI	0x19		/* watchpoint */
#define	C0_ECC		0x26		/* S-cache ECC and primary parity */
#define	C0_CACHE_ERR	0x27		/* cache error status */
#define	C0_TAGLO	0x28		/* cache operations */
#define	C0_TAGHI	0x29		/* cache operations */
#define	C0_ERROR_EPC	0x30		/* ECC error prg. counter */
